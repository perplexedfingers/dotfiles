...
let g:deoplete#sources#go = 'vim-polyglot'
...
imap <silent><expr><CR> delimitMate#WithinEmptyPair() ? "\<Plug>delimitMateCR" : "\<CR>"
...
smap <silent><expr><Tab> pumvisible() ? "\<C-n>" : (<SID>is_whitespace() ? "\<Tab>" : deoplete#manual_complete())
