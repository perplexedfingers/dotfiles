...
" autocomplete source
call dein#add('prabirshrestha/asyncomplete-buffer.vim', {'depends': 'asyncomplete.vim'})
call dein#add('prabirshrestha/asyncomplete-tags.vim', {'depends': ['asyncomplete.vim', 'vim-gutentags']})
call dein#add('prabirshrestha/vim-lsp', {'depends': 'asyncomplete.vim'})
call dein#add('yami-beta/asyncomplete-omni.vim', {'depends': 'asyncomplete.vim'})
call dein#add('prabirshrestha/async.vim', {'depends': 'asyncomplete.vim'})
call dein#add('wellle/tmux-complete.vim', {'depends': 'async.vim'})

" LSP
call dein#add('prabirshrestha/asyncomplete-lsp.vim', {'depends': 'vim-lsp'})
call dein#add('machakann/vim-lsp-julia', {'on_ft': 'julia', 'depends': 'asyncomplete-lsp.vim'})
...
call dein#add('sheerun/vim-polyglot', {'depends': 'context_filetype.vim'})
