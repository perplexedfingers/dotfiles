...
nmap <Leader>ns :setlocal spell!<cr>
nmap <Leader>nh :nohlsearch<CR>
" nmap <Leader>nn :setlocal nonumber! norelativenumber!<CR>
" nmap <Leader>nl :setlocal nolist!<CR>
" nmap <Leader>nw :setlocal wrap! breakindent!<CR>
